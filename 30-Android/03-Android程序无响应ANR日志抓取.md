...
一个流畅的合理的应用程序中不能出现ANR，ANR会导致用户体验变差。默认情况下，在Android中Activity的最长执行时间是5秒，BroadcastReceiver的前台广播最长执行时间是10秒，后台广播最长执行时间是60秒，Service的最长执行时间是20秒（前台）或200秒（后台）。

![1585466589069](./assets/03-Android程序无响应(ANR)日志抓取.assets/1585466589069.png)

## 2. 为什么会出现ANR

在Android系统中，通过Activity Manager和Window Manager服务来监控应用程序的响应情况，如果应用程序响应时间超出了限定时间，为了避免对用户体验造成困扰，系统会弹出ANR对话框来让用户选择是否继续等待。
...
![1585466042439](./assets/03-Android程序无响应(ANR)日志抓取.assets/1585466042439.png)
...
![1585466215165](./assets/03-Android程序无响应(ANR)日志抓取.assets/1585466215165.png)

然后我们打开traces.txt进行分析

![1585466589068](./assets/03-Android程序无响应(ANR)日志抓取.assets/1585466589068.png)
...
<p align="center">
    ...
    <a href="https://blog.csdn.net/dkbnull/article/details/105179536" target="_blank">
       <img src="https://img.shields.io/badge/CSDN-访问地址-red?logo=csdn">
    </a>
    <a href="https://mp.weixin.qq.com/s/CCh7HghMKkZDGSWiBeCbMA" target="_blank">
       <img src="https://img.shields.io/badge/微信公众号-访问地址-brightgreen?logo=wechat">
    </a>
	<a href="https://zhuanlan.zhihu.com/p/613031195" target="_blank">
